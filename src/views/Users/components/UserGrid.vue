    ...
    >
      <tr class="p-4">
        ...
        <th class="py-3.5 text-sm font-semibold text-gray-900" scope="col">
          <a
            class="group inline-flex cursor-pointer"
            @click="toggleSortOrder('lastName')"
          >
            Last Name
            <span
              :class="
            ...
            >
              <ChevronDownIcon
                v-if="
                  params.sortBy === 'lastName' && params.sortOrder === 'desc'
                "
                class="h-5 w-5"
              />
              <ChevronUpIcon v-else class="h-5 w-5" />
        ...
        <th class="py-3.5 text-sm font-semibold text-gray-900" scope="col">
          <a class="group inline-flex cursor-pointer"> Team Name </a>
        </th>
        <th class="py-3.5 text-sm font-semibold text-gray-900" scope="col">
          <a
            class="group inline-flex cursor-pointer"
            @click="toggleSortOrder('email')"
          >
            Email
            <span
              :class="
            ...
            >
              <ChevronDownIcon
                v-if="params.sortBy === 'email' && params.sortOrder === 'desc'"
                class="h-5 w-5"
              />
              <ChevronUpIcon v-else class="h-5 w-5" />
            </span>
        ...
        <th class="py-3.5 text-sm font-semibold text-gray-900" scope="col">
          <a class="group inline-flex cursor-pointer"> Role </a>
        </th>
        <th class="py-3.5 text-sm font-semibold text-gray-900" scope="col">
          <a
            class="group inline-flex cursor-pointer"
            @click="toggleSortOrder('createdAt')"
          >
            Created At
            <span
              :class="
      ...
      <tbody v-if="!spin" class="divide-y divide-blue-100">
        ...
        >
          ...
          <td
            class="whitespace-nowrap px-5 p text-sm font-medium text-gray-900"
          >
            {{ formatters.toProperCase(user.lastName) }}
          </td>
          <td
            class="whitespace-nowrap px-5 p text-sm font-medium text-gray-900"
          >
